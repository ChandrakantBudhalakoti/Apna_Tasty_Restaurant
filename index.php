  ...
  <body>
    ...
    <header class="l-header" id="header">
      <nav class="nav bd-container">
        <a href="#" class="nav__logo">Apna Tasty Restaurant</a>
      ...
      <section class="menu section bd-container" id="menu">
        ...
        <div class="menu__container bd-grid">
          <div class="menu__content">
            ...
            <span class="menu__preci">₹440</span>
          ...
          <div class="menu__content">
            ...
            <span class="menu__detail">Delicious dish</span>
            <span class="menu__preci">₹300</span>
            <a href="#" class="button menu__button"
              ><i class="bx bx-cart-alt"></i
            ></a>
          </div>
          ...
          <div class="menu__content">
            ...
            <span class="menu__detail">Delicious dish</span>
            <span class="menu__preci">₹275</span>
            <a href="#" class="button menu__button"
              ><i class="bx bx-cart-alt"></i
            ></a>
          </div>
        ...
        <div class="app__container bd-grid">
          <div class="app__data">
            ...
            <div class="app__stores">
              <a href="#"
                ><img src="img/app1.png" alt="" class="app__store"
              /></a>
              <a href="#"
                ><img src="img/app2.png" alt="" class="app__store"
              /></a>
            </div>
          </div>

          <img src="img/movil-app.png" alt="" class="app__img" />
        </div>
      </section>
      ...
      <section class="contact section bd-container" id="contact">
        <div class="contact__container bd-grid">
          ...
          <div class="contact__button">
            <a href="Contact-us.php" class="button">Contact us now</a>
          </div>
        </div>
      </section>
    </main>
    ...
    <footer class="footer section bd-container">
      <div class="footer__container bd-grid">
        <div class="footer__content">
          <a href="#" class="footer__logo">Apna Tasty</a>
        ...
        <div class="footer__content">
          ...
          <ul>
            <li>Near Amrapali Group of Institute</li>
            <li>Haldwani</li>
            <li>+91-9876543210</li>
            <li>apnatastyrestaurant@email.com</li>
          </ul>
        </div>
      </div>
